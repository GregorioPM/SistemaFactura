...
public class FacturaPdfView extends AbstractPdfView{
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter writer,
		...
		cell=new PdfPCell(new Phrase(messageSource.getMessage("text.datos.cliente",null, locale)));
		...
		cell=new PdfPCell(new Phrase(messageSource.getMessage("text.datos.factura",null, locale)));
